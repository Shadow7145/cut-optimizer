...
const SEO_CONTENT = {
  ru: {
    titleManual: 'Оптимизатор раскроя онлайн для ЛДСП, МДФ, фанеры и листовых материалов',
    titleAuto: 'Автоматический оптимизатор раскроя онлайн с расчетом карт раскроя и отходов',
    descriptionManual: 'Cut Optimizer помогает вручную строить карты раскроя листовых материалов: ЛДСП, МДФ, фанеры, пластика и металла. Сохраняйте проекты, печатайте PDF и снижайте отходы.',
    descriptionAuto: 'Онлайн калькулятор раскроя с автоматическим подбором раскладки деталей по листам, расчетом КПД, отходов и количества резов. Подходит для мебельного производства и мастерских.',
    keywords: 'оптимизатор раскроя, раскрой лдсп онлайн, карта раскроя онлайн, расчет раскроя листа, калькулятор раскроя, раскрой мдф, раскрой фанеры, cutting optimizer',
    heading: 'Cut Optimizer',
    subheading: 'Оптимизатор раскроя онлайн для мебельщиков, столяров и производств листовых материалов',
    intro: 'Сервис помогает рассчитывать раскрой ЛДСП, МДФ, фанеры, пластика и других листовых материалов. Можно вручную строить карту раскроя или автоматически распределять детали по листам с учетом размеров, пропила и поворота.',
    benefitsTitle: 'Что индексировать и ранжировать',
    benefits: [
      'Расчет раскроя онлайн без установки программ и регистрации.',
      'Оптимизация карт раскроя по нескольким алгоритмам с оценкой КПД, отходов и количества резов.',
      'Поддержка ручного режима для точной разметки и автоматического режима для быстрого расчета партии деталей.',
      'Сохранение проекта, печать PDF и наглядная спецификация деталей по каждому листу.',
    ],
    useCasesTitle: 'Под какие запросы страница должна быть релевантна',
    useCases: [
      'раскрой лдсп онлайн',
      'оптимизатор раскроя листовых материалов',
      'карта раскроя онлайн',
      'калькулятор раскроя лдсп',
      'программа для раскроя фанеры онлайн',
    ],
    faqTitle: 'FAQ по раскрою',
    faq: [
      {
